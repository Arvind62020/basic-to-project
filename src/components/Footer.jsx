    ...
    <footer className="bg-black text-white py-12 px-4 sm:px-6 lg:px-8 mt-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <span>Chandni Chowk , Old Delhi, DH-94041</span>
              </li>
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gray-300">Newsletter</h4>
            <p className="text-gray-400 mb-4">Subscribe to get special offers and travel tips</p>
            <form className="flex flex-col space-y-3">
              <input 
                type="email" 
                placeholder="Your email address" 
                className="px-4 py-2 rounded-full bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
              <button 
                type="submit" 
                className="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full font-medium hover:shadow-lg transition-all"
              >
                Subscribe
              </button>
            </form>
